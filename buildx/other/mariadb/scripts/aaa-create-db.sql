...
DROP FUNCTION IF EXISTS fn_addmilliseconds;
...
DROP PROCEDURE IF EXISTS `sp_admin_clean`;
DELIMITER $$
USE `dashcam`$$
...
-- -----------------------------------------------------
DROP PROCEDURE IF EXISTS `sp_admin_list_journey_chapters`;
DELIMITER $$
USE `dashcam`$$
...
-- -----------------------------------------------------
DROP PROCEDURE IF EXISTS `sp_admin_list_journeys`;
DELIMITER $$
USE `dashcam`$$
...
-- -----------------------------------------------------
DROP PROCEDURE IF EXISTS `sp_close_journey_chapter`;
DELIMITER $$
USE `dashcam`$$
...
-- -----------------------------------------------------
DROP PROCEDURE IF EXISTS `sp_create_journey_chapter`;
DELIMITER $$
USE `dashcam`$$
...
BEGIN
	...
	insert into journey_chapters (id, journey, start_time, filepath) 
		values(chapter_guid,journey_guid,journey_offset_ms,filepath);
...
-- -----------------------------------------------------
DROP PROCEDURE IF EXISTS `sp_delete_chapter`;
DELIMITER $$
USE `dashcam`$$
...
BEGIN
    ...
    delete from journey_chapters where journey_id=(journey) AND chapter_id=(id) and locked=0;
    
    select count(*) into chapter_count from journey_chapters where (journey)=journey_id;
    
    if chapter_count=0 then 
		delete from journeys where (id)=journey_id;
		end if;
...
-- -----------------------------------------------------
DROP PROCEDURE IF EXISTS `sp_end_journey`;
DELIMITER $$
USE `dashcam`$$
...
BEGIN
	...
	update journeys set end_time=journey_end where id=journey_guid;
...
-- -----------------------------------------------------
DROP PROCEDURE IF EXISTS `sp_list_old_chapters`;
DELIMITER $$
USE `dashcam`$$
...
-- -----------------------------------------------------
DROP PROCEDURE IF EXISTS `sp_new_journey`;
DELIMITER $$
USE `dashcam`$$
...
insert into journeys (id, start_time) values(journey_guid,journey_start);
...
-- -----------------------------------------------------
DROP PROCEDURE IF EXISTS `sp_set_journey_basetime`;
DELIMITER $$
USE `dashcam`$$
...
BEGIN
	...
	update journeys set base_time=journey_base_time where id=journey_guid;
END$$
